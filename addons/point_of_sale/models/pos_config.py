...
class PosConfig(models.Model):
    ...
    # Deceipt config
    deceipt_api_base_url = fields.Char(string='Deceipt API Base URL', required=True)
    deceipt_portal_base_url = fields.Char(string='Deceipt Portal Base URL', required=True)
